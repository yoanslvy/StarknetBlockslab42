...
from src.erc721.library import ERC721
from src.introspection.ERC165 import ERC165
from src.erc721_enumerable.library import ERC721_Enumerable

from src.security.pausable import Pausable

from src.access.ownable import Ownable
...
func mint{
    ...
    let (supply: Uint256) = ERC721_Enumerable.total_supply()
    ERC721_Enumerable._mint(caller_address, supply)
    return ()
end
